...
namespace JetBrains.PsiFeatures.VisualStudio.SinceVs11.Theming
{
    ...
    [JetBrains.Application.ShellComponentAttribute()]
    public class Vs11SweaThemeColorFiller : JetBrains.ReSharper.Daemon.SolutionAnalysis.UI.Theming.SweaThemeColorFiller
    {
        public Vs11SweaThemeColorFiller(Microsoft.VisualStudio.Shell.Interop.IVsUIShell5 vsUiShell5) { }
...
namespace JetBrains.PsiFeatures.VisualStudio.SinceVs11.TypingAssist
{
    ...
    [JetBrains.ProjectModel.SolutionComponentAttribute()]
    public class HtmlTypingHandlerWithExternalChangeCookie : JetBrains.ReSharper.Feature.Services.TypingAssist.ITypingHandler
    {
        public HtmlTypingHandlerWithExternalChangeCookie(JetBrains.TextControl.Impl.TextControlTypingHandlers textControlTypingHandlers, JetBrains.DataFlow.Lifetime lifetime, JetBrains.ReSharper.Feature.Services.Lookup.ILookupWindowManager lookupWindowManager) { }
    ...
    [JetBrains.ProjectModel.SolutionComponentAttribute()]
    public class XamlTypingHandlerWithExternalChangeCookie : JetBrains.ReSharper.Feature.Services.TypingAssist.ITypingHandler
    {
        public XamlTypingHandlerWithExternalChangeCookie(JetBrains.TextControl.Impl.TextControlTypingHandlers textControlTypingHandlers, JetBrains.DataFlow.Lifetime lifetime, JetBrains.ReSharper.Feature.Services.Lookup.ILookupWindowManager lookupWindowManager) { }
        public bool QuickCheckAvailability(JetBrains.TextControl.ITextControl textControl, JetBrains.ReSharper.Psi.IPsiSourceFile projectFile) { }
    }
}