...
namespace JetBrains.VsIntegration.JustVs11.Hacks
{
    
    [JetBrains.Application.ShellComponentAttribute()]
    public class SuppressOwnerlessFloatingWindowsJustVs11 : JetBrains.VsIntegration.SinceVs11.Hacks.SuppressOwnerlessFloatingWindowsSinceVs11
    {
        public SuppressOwnerlessFloatingWindowsJustVs11(JetBrains.DataFlow.Lifetime lifetime, JetBrains.VsIntegration.Settings.VsToolsOptionsMonitor vsToolsOptionsMonitor, JetBrains.Application.Settings.ISettingsStore settingsStore) { }
    }
}
namespace JetBrains.VsIntegration.JustVs11.Interop
{
    
    [JetBrains.VsIntegration.Application.WrapVsInterfacesAttribute()]
    public class ExposeJustVs11Services : JetBrains.VsIntegration.Application.IExposeVsServices { }
}
namespace JetBrains.VsIntegration.JustVs11.ProjectModel
{
    
    public class VCProjectEngine11 : JetBrains.VsIntegration.VX.ProjectModel.VCProjectEngineMirror
    {
    ...
    public class VcxProjectPropertiesBuilder11 : JetBrains.VsIntegration.ProjectModel.ProjectProperties.VcxProjectPropertiesBuilder
    {
        public VcxProjectPropertiesBuilder11(JetBrains.VsIntegration.ProjectModel.ProjectProperties.ProjectActiveConfigurationAccessor activeConfigurationAccessor) { }
...
namespace JetBrains.VsIntegration.JustVs11.TabStrip
{
    
    [JetBrains.Application.ShellComponentAttribute()]
    public class TabbedToolWindowOptionsJustVs11 : JetBrains.UI.ToolWindowManagement.TabbedToolWindowOptions
    {
        public TabbedToolWindowOptionsJustVs11(JetBrains.DataFlow.Lifetime lifetime) { }
    }
}
namespace JetBrains.VsIntegration.JustVs11.TextControl
{
    
    [JetBrains.Application.ShellComponentAttribute()]
    public class VsTextControlDevTenIncrementalSearchClientJustVs11 : JetBrains.VsIntegration.SinceVs11.TextControl.VsTextControlDevTenIncrementalSearchClientSinceVs11
    {
        public VsTextControlDevTenIncrementalSearchClientJustVs11([JetBrains.Annotations.NotNullAttribute()] JetBrains.Util.Lazy.Lazy<Microsoft.VisualStudio.Text.IncrementalSearch.IIncrementalSearchFactoryService> incrementalSearchFactoryService, [JetBrains.Annotations.NotNullAttribute()] Microsoft.VisualStudio.Editor.Implementation.IVsFindManagerHelper vsFindManagerHelper) { }
